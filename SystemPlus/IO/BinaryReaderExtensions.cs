...
namespace SystemPlus.IO
{
    ...
    public static class BinaryReaderExtensions
    {
        ...
        public static float Ibm32ToIeee32(byte[] b)
        {
            ...
            float posResult = mantissa * (float)Math.Pow(16.0, (b[0] & 0x7F) - 64);
        ...
        /// <summary>
        /// *** Untested! ***
        /// Converts a 64bit floating point from IBM to IEEE
        /// </summary>
